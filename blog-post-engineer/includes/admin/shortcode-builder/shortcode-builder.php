...
$preview_url 			= add_query_arg( array( 'page' => 'bdpp-shortcode-preview', 'shortcode' => $preview_shortcode, '_wpnonce' => wp_create_nonce( 'bdpp_shortcode_preview' ) ), admin_url('admin.php') );
