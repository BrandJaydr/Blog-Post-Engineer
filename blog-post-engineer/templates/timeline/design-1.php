...
?>
<div class="<?php echo esc_attr( $atts['wrp_cls'] ); ?>">
	<div class="bdpp-timeline-dot"></div>
	<div class="bdpp-timeline-content">
		<?php if ( $atts['feat_img'] ) { ?>
		<div class="bdpp-timeline-img">
