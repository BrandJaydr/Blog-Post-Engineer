...
?>
<div class="bdpp-post-grid bdpp-post-grid-design3 <?php echo esc_attr( $atts['wrp_cls'] ); ?>">
	<?php if ( $atts['feat_img'] ) { ?>
	<div class="bdpp-post-img-bg bdpp-post-img-bg-overlay" style="background-image: url('<?php echo esc_url( $atts['feat_img'] ); ?>');">
