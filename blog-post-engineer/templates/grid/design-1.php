...
<div class="bdpp-post-grid <?php echo esc_attr( $atts['wrp_cls'] ); ?>">
	<div class="bdpp-post-grid-content">
		...
		<div class="bdpp-post-img-bg">
			<a href="<?php echo esc_url( $atts['post_link'] ); ?>"<?php echo ( $atts['link_behaviour'] === 'new' ) ? ' target="_blank" rel="noopener"' : ''; ?>>
		...
		<h2 class="bdpp-post-title">
			<a href="<?php echo esc_url( $atts['post_link'] ); ?>"<?php echo ( $atts['link_behaviour'] === 'new' ) ? ' target="_blank" rel="noopener"' : ''; ?>><?php the_title(); ?></a>
		</h2>
		...
		<div class="bdpp-post-content">
			...
			<a href="<?php echo esc_url( $atts['post_link'] ); ?>" class="bdpp-rdmr-btn"<?php echo ( $atts['link_behaviour'] === 'new' ) ? ' target="_blank" rel="noopener"' : ''; ?>><?php echo wp_kses_post( $atts['read_more_text'] ); ?></a>
			<?php } ?>
		</div>
		<?php }
