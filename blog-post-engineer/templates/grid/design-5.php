<?php
/**
 * Grid Template 5 - Horizontal Split Card
 * 
...
?>
<div class="bdpp-post-grid bdpp-post-grid-design5 <?php echo esc_attr( $atts['wrp_cls'] ); ?>">
	<div class="bdpp-post-grid-split">
		<?php if ( $atts['feat_img'] ) { ?>
		<div class="bdpp-post-grid-left">
			<div class="bdpp-post-img-bg">
				<a href="<?php echo esc_url( $atts['post_link'] ); ?>"<?php echo $link_target; ?>>
					<img src="<?php echo esc_url( $atts['feat_img'] ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" />
				</a>
			</div>
		</div>
		<?php } ?>
		
		<div class="bdpp-post-grid-right">
