...
if ( ! class_exists( 'Blog_Designer_Pack_Lite' ) )  :
	...
	final class Blog_Designer_Pack_Lite {
		...
		private function setup_constants() {
			...
			$this->define( 'BDP_VERSION', '4.0.11' ); // Version of plugin
			...
			$this->define( 'BDP_UPGRADE_URL', 'https://github.com/BrandJaydr/gg-blogging-engine' ); // GitHub repository for free fork
		}
